...
def get_global_cache(
    max_size: int = 100, ttl_seconds: int = 86400, enable_lru: bool = True
) -> "CacheService":
...
class CacheService:
    ...
    def __init__(
        self, max_size: int = None, ttl_seconds: int = None, enable_lru: bool = True
    ):
    ...
    def generate_hash(
        self, content: str, doc_type: str, extra_requirements: str = None
    ) -> str:
