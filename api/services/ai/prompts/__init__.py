from .es import ES_CONFIGS, ES_REFERENCE_TEMPLATE, ES_CHUNK_PROMPT
from .en import EN_CONFIGS, EN_REFERENCE_TEMPLATE, EN_CHUNK_PROMPT
...
DANGEROUS_WORDS = {
    "es": [
        "indice", "índice", "introduccion", "introducción", "conclusion", "conclusión",
        "resumen", "estructura completa", "tabla de contenido", "capitulo", "capítulo",
        "sección", "seccion", "glosario", "bibliografía", "referencias"
    ],
    "en": [
        "index", "table of contents", "introduction", "conclusion", "summary",
        "complete structure", "chapter", "section", "glossary", "bibliography", "references"
    ]
}
