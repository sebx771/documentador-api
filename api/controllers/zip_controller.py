...
class ZipController:
    def __init__(self):
        ...
        self.cache_service = get_global_cache(
            max_size=100,
            enable_lru=True
        )
    ...
    def upload_zip(self, file, doc_type='markdown', extra_requirements='', language=None):
        """
        ...
        try:
            ...
            if doc_type == 'markdown':
                return self._generar_markdown(result['documentation'], cache_stats, elapsed)
            elif doc_type == 'pdf':
